...
10. [SQL-запрос: динамика количества заказов по дням/неделям/месяцам](#динамика-количества-заказов-по-днямнеделяммесяцам)
...
13. [Визуализация в Python](#визуализация-в-python)
